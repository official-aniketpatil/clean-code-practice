...
import static com.epam.engx.cleancode.complextask.task1.TablePrinter.TableBorderStyle.*;
...
public class TablePrinter implements Command {
    ...
    private static final String EMPTY_TABLE_MESSAGE_TEMPLATE = "Table '%s' is empty or does not exist";
    ...
    private void validateCommand(String commandString) {
        String[] commandElements = commandString.split(COMMAND_SEPARATOR);
    ...
    private String printEmptyTable(String tableName) {
        String textEmptyTable = String.format(EMPTY_TABLE_MESSAGE_TEMPLATE, tableName);
    ...
    private String printTableBorder(TableBorderStyle borderStyle) {
